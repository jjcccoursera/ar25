...
Implantada no GAE em 250607
Tem um erro: Nos votos válidos estão incluídos brancos e nulos
Mesmo erro na versão de app.js na implantação dessa data:
está Total_votes no subtotal de votos válidos e
no denominador das % de votos, quando devia estar
isso menos os brancos e nulos.
